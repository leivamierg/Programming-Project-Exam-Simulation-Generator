...
public class QuestionUtils {
    ...
    public static Question question1_1_1_CSA_FL;
    public static Question question1_2_1_CSA_FL;

    // Question 1.1.1 -> first topic - first subtopic - first question
    // Question 1.1.2 -> first topic - first subtopic - second question

    public static Question question1_1_1;
    public static Question question1_1_2;

    // Question 1.2.1 -> first topic - second subtopic - first question
    // Question 1.2.2 -> first topic - second subtopic - second question
    public static Question question1_2_1;
    public static Question question1_2_2;
    ...
    public static Question question1_3_1;
    public static Question question1_3_2;
    public static Question question1_3_3;
    ...
    public static Question question2_1_1_LA_FL;
    public static Question question2_2_1_LA_FL;
    ...
    public static Question question2_1_1;
    public static Question question2_1_2;
    public static Question question2_1_3;

    // Question 2.2.1 -> second topic - second subtopic - first question
    // Question 2.2.2 -> second topic - second subtopic - second question
    public static Question question2_2_1;
    public static Question question2_2_2;
    ...
    public static Question question2_3_1;
    public static Question question2_3_2;
    public static Question question2_3_3;

    // Question 2.4.1 -> second topic - fourth subtopic - first question
    // Question 2.4.2 -> second topic - fourth subtopic - second question
    // Question null -> null
    public static Question question2_4_1;
    public static Question question2_4_2;
    public static Question nullQuestion;

    public static void init() {
        // Question 1.1.1 CSA FL
