...
public interface FileLoadingInt {
     ...
     */
    public List<TopicInt> loadBank(String bankName);
     ...
     */
    TopicInt loadFile(String fileName);
     ...
     */
    SubtopicInt loadSubtopic(String fileName, String subtopicName);

    /**
     * loads a question of a given subtopic
     * 
     * @param fileName          path to the input bank file that contains the
     *                          question
     ...
     */
    QuestionInt loadQuestion(String fileName, String subtopicName, String questionStatement);

    /**
     *
     * @return a list of all available topics for the user
     */
    List<TopicInt> getTopics();
