...
public class ExamTimer implements Runnable {
     ...
     * The timer is initially set to running and the remaining time is set to the
     ...
     * Decrements the remaining time every second and prints the time in minutes and
     * seconds.
